        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative cursor-pointer h-16 w-16 flex items-center justify-center group">
            {user?.username ? (
              ...
              <div className="-z-4 absolute top-3 h-0 w-12 overflow-hidden group-hover:h-28 transition-all duration-300 ease-in-out flex flex-col items-center justify-end rounded-3xl bg-blue-200 py-5 text-red-500">
