                ...
                <div className="bg-white max-w-3xl p-8 rounded-lg h-[80vh] overflow-y-auto w-full">
                    <div className='flex flex-col gap-8'>
                        ...
                        <div>
                            ...
                            <p className="mb-4">In rare circumstances, such as a billing error or technical issue preventing access to the software, you may contact our support team at <a href="mailto:support@loomifyinnovations.com" className="text-blue-600">support@loomifyinnovations.com</a> for assistance. Refunds will only be considered at our sole discretion.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-6 text-center">For any inquiries or concerns, please reach out to <a href="mailto:support@loomifyinnovations.com" className="text-blue-600">support@loomifyinnovations.com</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
