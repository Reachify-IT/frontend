...
export default function Notifications() {
  ...
  return (
    <div>
      <div className="relative shoadow rounded-xl bg-blue-100 max-w-2xl m-auto flex flex-col gap-4 z-50 py-2 overflow-y-auto h-[80vh] lg:h-[450px] px-4  no-scrollbar">
