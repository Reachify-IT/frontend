...
const GoogleAuth = () => {
    ...
    const [isMailChangeModalOpen, setIsMailChangeModalOpen] = useState(false);
    ...
    const handleChangeMail = async () => {
        const result = await Swal.fire({
            title: "Are you sure?",
            text: "Your existing mail entry will be overwritten!",
            icon: "warning",
            ...
            <div className="flex items-center justify-center  pt-10">
                {data.email != null || googledata.email != null || imapdata.email != null ? (
                    <div className="relative max-w-md flex h-80 items-center justify-center flex-col  bg-blue-100 rounded-2xl">
                        ...
                        <p className="text-red-600 underline cursor-pointer" onClick={handleChangeMail}>Change your mail here</p>
                    </div>
                ) : (
                ...
                {isMailChangeModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center z-50">
                        {/* Overlay */}
                        <div className="absolute inset-0 bg-[#00000080] bg-opacity-100" onClick={() => setIsMailChangeModalOpen(false)}></div>

                        {/* Modal Content */}
                        <div className="relative bg-white rounded-lg shadow-lg p-6 z-50 max-w-md w-full">
                            <div className="absolute top-2 right-2">
                                <button
                                    onClick={() => setIsMailChangeModalOpen(false)}
                                    className="px-4 py-2 transition duration-200 cursor-pointer"
                                >
                                    <IoClose className="text-3xl text-red-500" />
                                </button>
                            </div>
                            <div className="flex items-center justify-center pb-4 flex-col">
                                <h1 className="text-blue-900 text-xl font-semibold">Change Email</h1>
                                <div className="flex flex-col mt-2 items-center justify-center w-80 bg-blue-100 gap-10 py-16 shadow rounded-2xl px-10">
