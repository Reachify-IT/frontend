        ...
        <div className='bg-white' >
            ...
            <section>
                <div className='container'>
                    <div className='flex items-center  flex-col pb-20'>
                        <h1 className='text-4xl font-semibold  '>Who is Loomify For?</h1>
            ...
            <section className='relative overflow-hidden' id="features-section">
                ...
                <div className='container relative z-10 '>
                    <div className='pb-10 flex items-center justify-center flex-col h-full'>
                        <h1 className='text-2xl sm:text-4xl font-semibold text-center'>What Makes Loomify a Game-Changer?</h1>
                        ...
                        <div className="card-section grid grid-cols-1 sm:grid-cols-2 gap-12 max-w-3xl h-full justify-center py-20 px-3">
                            ...
                            <div className='bg-blue-50 shadow w-full flex items-center flex-col p-6 hover:bg-blue-100 relative z-10 transition-all duration-300 ease-in-out gap-2 rounded-3xl'>
                                <div className='flex items-center justify-center text-white p-4 rounded-full bg-blue-700 text-5xl '>
                                    <FaVideo />
                                </div>
                        ...
                        <div>
                            <Link to='/sign-up'>
                                <button className='mt-5 hover:border-blue-700 hover:text-black hover:bg-transparent border broder-white bg-blue-700 px-10 py-3 text-white rounded-3xl cursor-pointer font-semibold relative z-10 transition-all duration-300 ease-in-out' >Try Loomify Free Today! </button>
                            </Link>
                        </div>
            ...
            <section>
                <div className='container'>
                    <div className='flex flex-col items-center justify-center pb-20 pt-28'>
                        <h1 className='text-2xl sm:text-4xl font-semibold text-center'>How It Works – 3 Simple Steps</h1>
                            ...
                            <div className="relative top-0 w-full sm:w-1/2 h-96   sm:p-6 flex flex-col justify-between pl-10">
                                <div className="flex flex-col justify-between h-full">
                                    <div className="one p-4 rounded-lg ">
                                        <h1 className="text-lg font-bold text-blue-900">Upload Your Video Template</h1>
                                        <p className="text-sm text-gray-700">
                                            Record a short, generic video for your outreach—no need to personalize each one manually.
                                        </p>
                                    </div>
                                    <div className="two p-4 rounded-lg ">
                                        <h1 className="text-lg font-bold text-blue-900">Upload Your Leads & Links</h1>
                                        <p className="text-sm text-gray-700">
                                ...
                                <div className="absolute  h-full text-2xl font-semibold left-0 sm:left-[-27px] top-0 py-10 flex flex-col items-center">
                                    ...
                                    <div className="relative flex flex-col justify-between items-center h-full">
                                        <div className="absolute w-1 bg-blue-700 h-full top-0 left-1/2 transform -translate-x-1/2"></div>
                        ...
                        <div>
                            <Link to='/sign-up'>
                                <button className='mt-5 hover:border-blue-700 hover:text-black hover:bg-transparent border broder-white bg-blue-700 px-10 py-3 text-white rounded-3xl cursor-pointer font-semibold relative z-10 transition-all duration-300 ease-in-out'>Start for Free! </button>
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div className='flex items-center justify-center flex-col pb-20'>
                    ...
                    <ClientStories />
                    <h1 className='text-2xl sm:text-4xl font-semibold text-center'>See for yourself</h1>
                    <div>
                        <Link to='/sign-up'>
            ...
            <section>
                <div className='container'>
                    <div className="py-10 flex items-center justify-center flex-col w-full h-full px-5">
                        <div className='bg-blue-600 px-3 sm:px-20 py-10 rounded-3xl text-white '>
                            <h1 className='text-4xl font-bold max-w-[30ch]'>Get More Replies & Close More Deals—Faster!</h1>
                            <ul className='list-none py-2 space-y-1'>
                                <li className="relative pl-6 before:content-['◆'] before:absolute before:left-0 before:text-white ">Save Time. Scale Outreach. Increase Engagement.</li>
                                <li className="relative pl-6 before:content-['◆'] before:absolute before:left-0 before:text-white ">AI-personalized video + automated email outreach = higher conversions</li>
                            </ul>
                            <div className='flex items-center justify-center sm:justify-start'>
                                <Link to='/sign-up'>
                                    <button className='mt-5 border border-blue-700 hover:bg-transparent hover:border-white hover:border hover:text-white bg-gray-100 px-10 py-3 text-blue-900 rounded-3xl cursor-pointer font-semibold relative z-10 transition-all duration-300 ease-in-out'>
            ...
            <section>
                <div className='container'>
                    <div className="py-20 flex items-center justify-center flex-col">
                        <h1 className='text-2xl sm:text-4xl font-semibold text-center'>Frequently Asked Questions (FAQs)</h1>
                        <div>
                            <CustomAccordion />
                        </div>
                    </div>
            ...
            <footer>
                <div className='bg-[#002b7f] w-full h-full px-3 sm:px-20 py-10'>
                    <div className='flex items-center text-white justify-center sm:justify-start'>
                        ...
                        <img src={logosmall} alt="" className="h-20 w-20 filter invert" />
                        <h1 className='text-xl'>Reachify</h1>
                    </div>
                    <div className='text-white flex-col sm:flex-row flex items-center  sm:items-start justify-center  sm:justify-between mt-10'>
                        <div className='w-full sm:w-1/2'>
                            ...
                            <ul className='list-none space-y-2 mt-5'>
                                ...
                                <li className='flex items-center gap-2 hover:text-neutral-300 cursor-pointer' > <FaCheck className='text-xl h-5 w-5 p-1 bg-green-500 rounded-lg text-white' /> Get More Replies, More Conversions, & More Sales</li>
                                <li className='flex items-center gap-2 hover:text-neutral-300 cursor-pointer' > <FaCheck className='text-xl h-5 w-5 p-1 bg-green-500 rounded-lg text-white' /> No More Manual Outreach – Let AI Do the Heavy Lifting</li>
                                <li className='flex items-center gap-2 hover:text-neutral-300 cursor-pointer' > <FaCheck className='text-xl h-5 w-5 p-1 bg-green-500 rounded-lg text-white' /> 100% Free Trial – Start in 60 Seconds!</li>
                            </ul>
                        </div>
                    ...
                    <div>
                        <Link to='/sign-up'>
                            <button className='text-wrap mt-5 border border-blue-700 hover:bg-transparent hover:border-white hover:border hover:text-white bg-gray-100 px-10 py-3 text-blue-900 rounded-3xl cursor-pointer font-bold relative z-10 transition-all duration-300 ease-in-out'>
