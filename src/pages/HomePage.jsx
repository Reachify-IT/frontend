...
const notifications = [
    {
        ...
        message: "Your bulk video creation task has been successfully completed! All videos are now uploaded and ready for sharing."
    },
    {
        id: 2,
        title: " Task Stopped🚫",
        message: "Your scheduled report generation is done! You can now download your report from the dashboard."
    },
    {
        id: 3,
        title: "Scheduled Maintenance ⚙️",
        message: "Your data backup has been successfully completed and stored securely."
    },
    {
        id: 4,
        title: "Limit Exhausted – Upgrade Suggestion ⚠️",
        message: "All pending invoices have been processed successfully. Please review the payment logs."
    },
    {
        id: 5,
        title: "Task Completed ✅",
        message: "Your bulk email campaign has been sent successfully to all recipients."
    },
    {
        id: 6,
        title: "Task Completed ✅",
        ...
        <div className="relative  overflow-hidden flex justify-center items-center h-screen w-screen bg-white rounded-4xl">
            ...
            <div className="w-full  container flex items-center justify-center px-10 ">
                <div className="flex items-start justify-between w-full h-full mt-0 lg:mt-10">
                    {/* Sidebar */}
                    <div className="realtive z-50 sideNavbar w-[10%] h-full justify-center flex flex-col gap-5 items-center">
                        {/* Main Navigation */}
                        <div className="navWrapper w-14 rounded-full flex flex-col gap-3 items-center bg-blue-100 p-3">
                            {[
              ...
              ${activeSection === "preview" ? "bg-blue-700 text-white" : "hover:bg-blue-700 hover:text-white"}`}
                    ...
                    <div className="w-[85%] h-[75vh]">
                        ...
                        {activeSection === "notifications" && (
                            <>
                                <div className="relative flex flex-col gap-4 z-50 py-2 overflow-y-auto h-[80vh] lg:h-[450px] px-4 bg-tranprent rounded-lg no-scrollbar">
                                    {notifications.map((notification) => (
                                        <div key={notification.id} className="flex items-center bg-blue-100 py-3 rounded-3xl px-5 shadow-md">
                                            <div>
                                                <BiSolidMessageDots className="text-blue-700 h-16 w-16 px-2" />
                                            </div>
                                            <div className="border-l-2 border-blue-700 px-4">
