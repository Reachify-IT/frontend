...
function Layout() {
  ...
  const isLandingPage = location.pathname === "/" || location.pathname === "/privacy-policy" || location.pathname === "/terms-and-conditions" || location.pathname === "/refunds-policy" || location.pathname === "/pricing-page" || location.pathname === "/Contact-Us";
